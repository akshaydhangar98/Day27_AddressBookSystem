	        ...
	        while (choice != 10)
	        {
	            if (choice == 1) {
	                ...
	                else
	                {
	                    ...
	                    AddressBookMain.cityName.put(city,new Contact(fName, lName, number, city, state, pinCode));
	                    AddressBookMain.stateName.put(city,new Contact(fName, lName, number, city, state, pinCode));
	                }
